...
<?php foreach ($lista_tareas as $valor) : ?>
	...
	<td><?=$valor['fechar']?></td>
	<td><a name="modificar" href="?accion=modificar&id=<?=$valor['id']?>">Modificar</a></td>
   </tr>
<!-- id es el campo id dentro de nuestra tarea -->
<?php endforeach; ?>
</table>
<br></div>